...
namespace TICO.GAUDI.Commons.Test
{
    ...
    public partial class StubApplicationEngine : IApplicationEngine
    {
        ...
        /// 初期化時に通信クラスを設定する。					
        /// </summary>
        private static ILogger MyLogger { get; } = StubLoggerFactory.GetLogger(typeof(StubApplicationEngine));
        ...
        /// メッセージ受信時のイベントデータ					
        /// </summary>
        private Dictionary<string, MessageEventData> messageInputEventData = new Dictionary<string, MessageEventData>();


        /// <summary>
        /// ダイレクトメソッド受信時のイベントデータ
        /// </summary>
        private Dictionary<string, MethodEventData> methodRequestEventData = new Dictionary<string, MethodEventData>();
